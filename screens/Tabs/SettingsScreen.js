  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.detailText}>Name: Juan Dela Cruz</Text>
        ...
        <TouchableOpacity style={styles.buttonText} onPress={() => {/* Navigate to edit screen */}}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.listItem}>
            <Ionicons name="lock-closed-outline" size={20} color="#5908b4ff" />
            <Text style={styles.listItemText}>Change Password</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.listItem}>
            <Ionicons name="key-outline" size={20} color="#5908b4ff" />
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.listItem}>
            <Ionicons name="help-circle-outline" size={20} color="#5908b4ff" />
            <Text style={styles.listItemText}>Help Center</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.listItem}>
            <Ionicons name="document-text-outline" size={20} color="#5908b4ff" />
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: 'bold', marginBottom: 20, color: '#5908b4ff' },
  section: {
    backgroundColor: '#fff',
    borderRadius: 8,
    padding: 15,
